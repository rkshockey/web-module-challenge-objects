...
// console.log("task 2 teacher", burger.discount("teacher"));
// console.log("task 2 student", burger.discount("student"));
// console.log("task 2 public", burger.discount("public"));
...
*/
reviews.push({name: "Romy", rating: 4, feedback: "It'd be perfect if they had dimmer mood lighting!"})
//console.log(reviews)
...
*/
 ...
 function getReviewByRating(array, key, value) {
    let newArray = []
    for(let i = 0; i < array.length; i++){
      if (array[i][key] >= value && array[i][key] < value + 1){
...
function getLongReviews(array, key, words) {
    let newArray = [];
    let wordy = [];
    for (let i = 0; i < array.length; i++){
      wordy = array[i][key].split(" ");
      if (wordy.length >= words){
        newArray.push(array[i]);
      }
    }
    return newArray;
 ...
 // console.log(getLongReviews(reviews, "feedback", 15))
...
function carMaker(odometer) {
    return {odometer: odometer, drive: function(miles){
